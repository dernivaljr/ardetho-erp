...
> Note: Some image files may vary according to the assets used in the local project version.
...
### Profile
Allows editing the current user and company branding:
